...
void mx_str_reverse(char *s);//100 ??? changed
...
int mx_get_substr_index(const char *str, const char *sub);//? ??? changed
int mx_count_substr(const char *str, const char *sub);//100 ??? changed
int mx_count_words(const char *str, char c);//100 ??? changed
char *mx_strnew(const int size);//100
char *mx_strtrim(const char *str);//?
char *mx_del_extra_spaces(const char *str);//? ??? changed
char **mx_strsplit(const char *s, char c);//?
char *mx_strjoin(const char *s1, const char *s2);//100
char *mx_file_to_str(const char *file);//?
char *mx_replace_substr(const char *str, const char *sub, const char *replace);//? ??? changed
...
void mx_pop_back(t_list **head);//? ??? changed
